package com.example.shivankurkapoor.sunshine.sync;

/**
 * Created by Shivankur Kapoor on 22-07-2015.
 */
...
import com.example.shivankurkapoor.sunshine.MainActivity;
import com.example.shivankurkapoor.sunshine.R;
import com.example.shivankurkapoor.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        String format = "json";
        String units = "metric";
        String appid = "89a6fb9ed1ea2e2f96b539b5a0f6a576";
        int numDays = 14;
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                cvArrays = cVVector.toArray(cvArrays);
                inserted = getContext().getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cvArrays);
