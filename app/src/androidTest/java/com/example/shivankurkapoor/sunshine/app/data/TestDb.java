 ...
 */
package  com.example.shivankurkapoor.sunshine.app.data;
...
import com.example.shivankurkapoor.sunshine.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("No records from weather query", c.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        TestUtilities.validateCurrentRecord("Weather query failed", c,testValues);
    ...
    public long insertLocation() {
        ...
        assertTrue("No records from location query", c.moveToFirst());
        TestUtilities.validateCurrentRecord("Location query failed", c,testValues);

        //To check if there only one record
