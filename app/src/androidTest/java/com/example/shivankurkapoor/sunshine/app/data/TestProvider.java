...
import com.example.shivankurkapoor.sunshine.data.WeatherContract.LocationEntry;
...
import com.example.shivankurkapoor.sunshine.data.WeatherProvider;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testProviderRegistry() {
        ...
        Log.v(LOG_TAG,componentName.toString());
        try {
   ...
   /*
    ...
    public void testGetType() {
       ...
       // Log.v(LOG_TAG,"@@@@@@@@@@@@@@@@@@@@@"+WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate).toString());
